          ...
          <a-row :gutter="48">
            ...
            <a-col :md="6" :sm="24">
              <a-form-item label="科室名称">
                <a-input v-model="queryParam.jobGroup" placeholder="请输入科室名称" allow-clear @keyup.enter.native="handleQuery"/>
              </a-form-item>
            </a-col>
            <a-col :md="6" :sm="24">
              <a-form-item
                label="
              挂号状态">
                <a-select placeholder="请选择挂号状态" v-model="queryParam.status" style="width: 100%" allow-clear>
